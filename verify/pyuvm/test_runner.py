#!/usr/bin/env python3
"""Test runner for CF_I2S — uses cocotb.runner API."""
...
IP_NAME = "CF_I2S"
YAML_FILE = str(PROJ_PATH / "../../CF_I2S.yaml")

BUSES = ["APB", "AHB", "WISHBONE"]
BUS_CONFIGS = {
    "APB": {
        "design_name": "CF_I2S_APB",
        "clk": "PCLK",
        "rst": "PRESETn",
        "macro": "BUS_TYPE_APB",
    },
    "AHB": {
        "design_name": "CF_I2S_AHBL",
        "clk": "HCLK",
        "rst": "HRESETn",
        "macro": "BUS_TYPE_AHB",
    },
    "WISHBONE": {
        "design_name": "CF_I2S_WB",
        "clk": "clk_i",
        "rst": "rst_i",
...
def get_rtl_sources():
    ...
    sources.append(str(rtl_dir / "CF_I2S.v"))

    wrapper_dir = rtl_dir / "bus_wrappers"
    for name in ("CF_I2S_APB.v", "CF_I2S_AHBL.v", "CF_I2S_WB.v"):
...
def _fallback_reports(out_dir, results_list):
    ...
    md_lines.append("")
    md_lines.append("# CF_I2S Verification Results")
    md_lines.append("")
